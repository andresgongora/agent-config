...
Keep local deployment facts, source paths, and verified local traps here. Keep changing OpenCode
field catalogs in official docs and schema links. This prevents a pinned local package from turning
old claims into rules.

<!------------------------------------------------------------------------------------------------->
## Use
<!------------------------------------------------------------------------------------------------->

Load for local OpenCode configuration, deployed artifact paths, permission resolution, or Nix-backed
settings. Do not load for generic OpenCode questions with no local configuration angle.
...
- Keep snippets short and representative; do not copy generic documentation into runtime
  instructions.
