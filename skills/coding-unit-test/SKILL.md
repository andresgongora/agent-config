...
description: "Guides unit-test work in any language. Load for unit tests, TDD, testability, coverage, or test-framework choice. Skip for tiny glue and unstable spikes that need no test-first ritual, or for test infrastructure and CI configuration."
---
