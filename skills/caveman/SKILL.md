---
name: caveman
description: "Ultra-compressed communication mode that preserves technical meaning. Load when user requests caveman style, terse or brief output, lower verbosity, fewer tokens, or writing agent-directed artifacts. "
---
...
Unless explicit level requested:

- Session chat: `full`. Keep across session; keep terse, no filler drift.
- Agent-directed artifacts: `lite`. Skills, agents, commands. Terse but unambiguous, clarity first.
- Agent instructions, delegation: `full`. Counteract ambiguity with enough context. Never lose constraints.
