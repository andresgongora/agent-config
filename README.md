...
| `agent-author`     | File-form guidance and workflow for creating/editing skill files, subagent files, and agent definitions                       | Authoring or auditing any `SKILL.md`, `agents/*.md`, or agent definition  |                                                                                                                              |
...
| `local-markdown`   | Minimal Markdown completion checks                                                                                            | Writing, editing, finishing, or reviewing `.md` files                     |                                                                                                                              |
...
| `/commit`         | Plan, review, approve, then create safe atomic commits; does not push      |                                                                         |
