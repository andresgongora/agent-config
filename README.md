...
| `minion-delegation`     | Decides when to delegate bounded locating, surgical editing, review, or post-rework cleanup to `@minion-*` subagents          | Choosing or coordinating bounded repo-local delegation                                    |                                                                                                                              |
...
| `@minion-vestige-hunter`   | Read-only vestige hunter for a supplied file, directory, or repository area                            | Post-rework cleanup; find vestigial residue and ghost steps            |
...
| `@minion-fetcher`          | Exact-location information fetcher for URLs or local files and folders                                 | Extracting known-source data such as video metadata                    |
